...
object ATAssembler {
  ...
  functions += "add_A_to_B" -> 0x0130
  functions += "add_B_to_A" -> 0x0131
  functions += "sub_A_from_B" -> 0x0132
  functions += "sub_B_from_A" -> 0x0133
  functions += "mul_A_by_B" -> 0x0134
  functions += "mul_B_by_A" -> 0x0135
  functions += "div_A_by_B" -> 0x0136
  functions += "div_B_by_A" -> 0x0137
